...
const issueTypeListInn = [{
  code:1,name:'Proses Pendaftaran',
},{
  code:2,name:'Proses Pencairan Dana',
},{
  code:3,name:'Proses Pelunasan',
},{
  code:4,name:'Komplain',
},{
  code:5,name:' Market/promosi',
},{
  code:6,name:'lainlain',
},{
  code:7,name:'Proses verifikasi',
}];
const solutionListInn = [{
  code:1,name:'sudah selesai',
},{
  code:2,name:'lagi di followup',
},{
  code:3,name:'Sedang di follow up',
},{
  code:4,name:'tidak perlu di jawab',
}];
...
const getOrderTagListone = (val) => {
  let re = '';
  orderTagListInn.forEach(function(obj) {
    if (obj.code == val) {
      re = obj.name;
      return
    }
...
const orderPro = [{
  ...
  code: "10",
  name: "正常已还款"// 订单生命周期完成 (正常完成)
},{
  code: "11",
  name: "逾期已还款"// 订单生命周期完成 (正常完成)
},{
  code: "12",
  name: "机审不通过"// (异常完成)
},{
  ...
  code: "15",
  name: "取消"// 因为审核不通过被取消，订单生命周期完成(异常完成)
},{
  code: "16",
  name: "打款失败"// 因为审核不通过被取消，订单生命周期完成(异常完成)
},{
  code: "17",
  name: "等待外呼"// 因为审核不通过被取消，订单生命周期完成(异常完成)
},{
  code: "18",
  name: "初审后等待外呼"
},{
...
const getBankStatus = (val) => {
  let re = '';
  bankStatus.forEach(function(obj) {
    if (obj.code == val) {
      re = obj.name;
      return
    }
...
const getBankStatusInn = (val) => {
  let re = '';
  bankStatusInn.forEach(function(obj) {
    if (obj.code == val) {
      re = obj.name;
      return
    }
