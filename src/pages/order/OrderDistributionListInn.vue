...
<script>
import mlOrderList from '../../components/OrderListInn.vue';
export default {
	data() {
		return {
			tabList: [],
	...
	methods: {
		getTabList() {
			...
			this.activeName = 'Daftar verifikasi permohonan - manual pertama';
			this.tabList.push({"id": 'JUNIOR_REVIEWER',"createTime": 1501506137000,"dicId": 11,"dicItemName": "Daftar verifikasi permohonan - manual pertama","dicItemValue": "FIRST_CHECK",
				"disabled": 0,
				"remark": "",
				"updateTime": 1501506137000,
				"uuid": "0A36BFC18E7F4DEEACAA006CC8A089E6",
			});
			this.tabList.push({"id": 'SENIOR_REVIEWER',"createTime": 1501506137000,"dicId": 11,"dicItemName": "Daftar verifikasi permohonan - manual akhir","dicItemValue": "SECOND_CHECK",
				"disabled": 0,
				"remark": "",
				"updateTime": 1501506137000,
				"uuid": "0A36BFC18E7F4DEEACAA006CC8A089E6"});
