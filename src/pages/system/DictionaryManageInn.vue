<template>
  <section>
    ...
    <el-form :inline="true" class="toolbar">
      <el-form-item>
        <el-button @click="addRoot" type="success">Tambahkan induk kata</el-button>
      </el-form-item>
    </el-form>
    <!--列表-->
...
<!--添加父字典或子字典-->
<el-dialog title="Tambahkan kata" v-model="addDialogVisible" :close-on-click-modal="false" size="tiny">
  <el-form :model="addForm" label-position="left" label-width="80px" :rules="inputRule" ref="addForm">
    <el-form-item label="Tambahkan kode" prop="dicCode">
      <el-input v-model="addForm.dicCode" auto-complete="off"></el-input>
    </el-form-item>
    <el-form-item label="Nama kamus" prop="dicName">
...
<!--修改-->
<el-dialog title="Ubah kamus" v-model="editDialogVisible" :close-on-click-modal="false" size="tiny">
  <el-form :model="editForm" label-position="left" label-width="80px" :rules="inputRule" ref="editForm">
    ...
    <el-form-item label="Nama" prop="dicName">
    ...
    methods: {
      ...
      renderContent(h, {
       ...
       return (
        ...
        <el-button disabled={node.level!=1} type="success" size = "small"  on-click = {() => this.addNode(data)} >Tambahkan anak kata</el-button>
        <el-button size = "small" on-click = {() => this.edit(data,node)} >Ubah</el-button>
