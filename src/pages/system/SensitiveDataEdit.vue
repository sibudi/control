...
<template>
  ...
  <el-tabs type="border-card">
    ...
    <el-tab-pane label="代扣调整">
      <el-row class="toolbar">
        <el-form :inline="true" :model="ReplacePay" ref="ReplacePay">
          <el-form-item label="订单编号" prop="orderNo">
            <el-input  v-model="ReplacePay.orderNo" :maxlength="20"></el-input>
          </el-form-item>    
          <el-form-item>
            <el-button type="primary" @click="ReplacePayConfirm" :loading="ReplacePayLoading" ref="HandleChange">代 扣</el-button>
          </el-form-item>
        </el-form>
      </el-row> 
    </el-tab-pane>

    <el-tab-pane label="发送短信">
      <el-row class="toolbar">
        <el-form :inline="true" :model="sendMsgForm" ref="sendMsgForm" label-width="80px">
          <el-form-item label="发送渠道">
            <el-select v-model="sendMsgForm.smsType" placeholder="请选择" clearable>
              <el-option label="漫道" key="1" value="1"></el-option>
              <el-option label="阿里云" key="2" value="2"></el-option>
            </el-select>
          </el-form-item><br>  
         <el-form-item label="开始ID" prop="begId">
            <el-input  v-model="sendMsgForm.begId" :maxlength="20"></el-input>
          </el-form-item><br>
          <el-form-item label="结束ID" prop="endId">
            <el-input  v-model="sendMsgForm.endId" :maxlength="20"></el-input>
          </el-form-item>  
          <el-form-item>
            <el-button type="primary" @click="sendMsgConfirm" :loading="sendMsgLoading" ref="HandleChange">确定发送</el-button>
          </el-form-item>
        </el-form>
      </el-row> 
    </el-tab-pane>
