<template>
  <section>
    ...
    <template>
      <el-table :data="gridData" highlight-current-row v-loading="gridLoading" class="grid">
        ...
        <el-table-column label="用户是否已登录" width="80">
          <template scope="scope">
            <el-tag :type="scope.row.onlineOrNot==true? 'primary' : 'danger'" close-transition>{{scope.row.onlineOrNot==true?'是':'否'}}</el-tag>
          </template>
        </el-table-column>
  ...
  <el-dialog title="添加用户" v-model="addDialogVisible" :close-on-click-modal="false" size="small">
    <el-form :model="addForm" label-position="left" label-width="100px" :rules="inputRule" ref="addForm">
      ...
      <el-form-item label="它是否是第三方平台？" prop="thirdPlatform">
  ...
  <el-dialog title="修改用户" v-model="editDialogVisible" :close-on-click-modal="false" size="small">
    <el-form :model="editForm" label-position="left" label-width="100px" :rules="inputRule" ref="editForm">
      ...
      <el-form-item label="备注" prop="remark">
        <el-input type="textarea" v-model="editForm.remark" auto-complete="off" :maxlength="20"></el-input>
      </el-form-item>
    </el-form>
    <div slot="footer" class="dialog-footer">
  ...
  data() {
    ...
    methods: {
      ...
      edit(row) {
        ...
        this.editForm.voicePhone = row.voicePhone
      },
      reset(row) {
