...
<template>
    ...
    <el-table :data="gridData" highlight-current-row v-loading="gridLoading" class="grid" border>
      <el-table-column label="Tahap" width="100" prop = "sysStage"></el-table-column>
    ...
    <el-table-column label="Lebih dari D1" prop="sysValue2">
      <template scope="scope">
        <el-switch name="index++"
        ...
        if(body.code ==1){
          ...
          for (let index = 0; index <tempData.length ; index ++) {
            if (tempData[index].sysKey.indexOf(":self:") != -1) {
              ...
              tempObject1.sysStage = 'Telepon saya';
              ...
              tempObject2.sysStage = 'Kontak alternatif';
              ...
              tempObject3.sysStage = 'Kontak Perusahaan';
              ...
              tempObject4.sysStage = 'Kontak alternatif saya';
              ...
              tempObject5.sysStage = 'Kontak Darurat';
              ...
              tempObject6.sysStage = 'Nomor kantor';
