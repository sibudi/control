<template>
  <section>
    ...
    <el-form :inline="true" class="toolbar">
      <el-form-item>
        <el-button @click="addRoot" type="success">添加组长</el-button>
      </el-form-item>
    </el-form>
    <!--列表-->
    ...
    <!--添加-->
    <el-dialog title="添加组长" v-model="addDialogVisible" :close-on-click-modal="false" size="tiny">
    ...
    <el-dialog title="添加组员" v-model="addDialogVisibleone" :close-on-click-modal="false" size="tiny">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addFormSubmitone" :loading="addFormLoadingone">提 交</el-button>
      </div>
    </el-dialog>
    <!--修改-->
      ...
      renderContent(h, {
        ...
        store
         ...
         return (
          ...
          <el-button disabled={node.level!=1} type="success" size = "mini"  on-click = {() => this.addNode(data)} >添加组员</el-button>
          <el-button  disabled={data.children&&data.children.length>0} type="danger" size = "mini"  on-click = {() => this.del(data)} >删除</el-button>
          </span></span>
        )
      },
      bindTree() {
