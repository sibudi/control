  ...
  <section>
    ...
    <el-form :inline="true" :model="searchForm" class="toolbar">
      ...
      <el-form-item label="催收人员">
        <el-input v-model="searchForm.collectionName" placeholder=""></el-input>
      </el-form-item>
    ...
    <section>
      <el-table :data="gridData" highlight-current-row border v-loading="gridLoading">
        ...
        <el-table-column label="反馈内容" prop="feedBackContent">
          <template scope="scope">
        ...
        <el-table-column label="被投诉催收人员" prop="collectionName" min-width="100">
        </el-table-column>
        <el-table-column label="备注" prop="remark"></el-table-column>
        <el-table-column label="解决情况" width="130">
        ...
        <el-table-column label="操作" prop="remark" width="250">
          <template scope="scope">
            ...
            <el-button size="small" @click.native.prevent="imgReview(scope.row.feedBackImages)" v-show="scope.row.feedBackImages">查看图片
          </el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      excelExport(){
        window.open(Config.host + "/manage/userFeedBackExcel?sessionId="+DataUtil.sid()+"&questionType="+this.searchForm.questionType+"&stageType="+this.searchForm.stageType+"&startTime="+DataUtil.formatTime(this.searchForm.startTime)+"&endTime="+DataUtil.formatTime(this.searchForm.endTime)+"&mobile="+this.searchForm.mobile+"&sourceType=1");
      },
      handleEdit(row) {
