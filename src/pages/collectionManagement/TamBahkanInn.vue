<template>
  <div id="getUserLastSmsCode">
    <el-form ref="form" :model="serchForm" :inline="true" label-width="80px" class="demo-form-inline">
      ...
      <el-form-item>
        <el-button type="primary" @click="bindGrid">tambahkan ke daftar blacklist</el-button>
      </el-form-item>
    </el-form>
    <el-form ref="form" :model="serchFormone" :inline="true" label-width="80px" class="demo-form-inline">
      ...
      <el-form-item>
        <el-button type="primary" @click="bindGridone">ditarik dari daftar blacklist</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
