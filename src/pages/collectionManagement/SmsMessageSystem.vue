<template>
  <section>
    ...
    <el-form :inline="true" :model="searchForm" class="toolbar">
      ...
      <el-form-item label="发送时间">
        <div class="block">
          <el-date-picker v-model="searchForm.minSendTime" type="date" :picker-options="pickerOptions1" :editable="false" placeholder="选择日期">
          </el-date-picker> ~
          <el-date-picker v-model="searchForm.maxSendTime" type="date" :picker-options="pickerOptions2" :editable="false" placeholder="选择日期">
          </el-date-picker>
        </div>
      </el-form-item>
      <el-form-item label="发送操作人">
        <el-input v-model="searchForm.sendUser"></el-input>
      </el-form-item>
      <el-form-item label="是否到达">
       <el-select v-model="searchForm.isArrived" placeholder="请选择" clearable>
  ...
  <template>
    <el-table :data="gridData" highlight-current-row v-loading="gridLoading" class="grid">
     <el-table-column label="发送操作人" prop="sender" min-width="120">
     </el-table-column> 
     <el-table-column label="发送时间" prop="sendTime" min-width="140" sortable>
     <!--  <template scope="scope">
        {{getdate(scope.row.sendTime)}}
      </template> -->
    </el-table-column>
    <el-table-column label="借款人" prop="loaner" min-width="140" >
    </el-table-column>
    <el-table-column label="接收人" prop="receiver" min-width="140" >
    </el-table-column>
    <el-table-column label="短信标题" prop="smsTitle" min-width="120" >
    </el-table-column>
    <el-table-column label="短信内容" prop="smsContent" min-width="300" >
    </el-table-column>
    <el-table-column label="是否到达" prop="isArrived" min-width="120">
     <template scope="scope">
      <el-tag :type="scope.row.isArrived==1? 'success' : 'danger'" close-transition>{{scope.row.isArrived==1?'是':'否'}}</el-tag>
    </template>
  </el-table-column>
</el-table>
