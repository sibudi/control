...
<template>
	<section>
		<el-table :data="gridData" highlight-current-row v-loading="gridLoading" class="grid" border>
			<el-table-column label="岗位" prop="postName" width="100"></el-table-column>
			<el-table-column label="上班人员" prop="realname">
			...
			<el-table-column label="操作" width="340">
				<template scope="scope">
					<el-button size="small" type="primary" @click="edit(scope.row, 1)">编辑岗位人员</el-button>
					<el-button size="small" type="success" @click="edit(scope.row, 2)">编辑休息人员</el-button>
					<el-button size="small" type="info" @click="tijiaoqua(scope.row)">导出评分</el-button>
				</template>
			</el-table-column>
		</el-table>
