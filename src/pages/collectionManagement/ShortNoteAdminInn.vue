<template>
  <section>
    ...
    <el-form :inline="true" class="toolbar">
      <el-form-item>
        <el-button @click="add" type="success">tambahkan template</el-button>
      </el-form-item>
    </el-form>
    <!--列表-->
    <template>
      <el-table :data="gridData" highlight-current-row v-loading="gridLoading" class="grid">
        ...
        <el-table-column prop="smsTemplateId" label="template id" width="150">
        </el-table-column>
        ...
        <el-table-column label="Opsi" width="200">
          <template scope="scope">
            <el-button size="small" @click="edit(scope.row,1)">Ubah</el-button>
