...
<template>
  <section>
    ...
    <el-form :inline="true" :model="searchForm" class="toolbar">
      <el-form-item label="Nama Kupon">
        <el-input v-model="searchForm.indonisaName"></el-input>
      </el-form-item>  
    ...
    <el-form-item label="waktu pembagian">
      <div class="block">
        <el-date-picker v-model="searchForm.sendStartTime" type="date" :picker-options="pickerOptions1" :editable="false" placeholder="Silahkan pilih">
        </el-date-picker> ~
        <el-date-picker v-model="searchForm.sendEndTime" type="date" :picker-options="pickerOptions2" :editable="false" placeholder="Silahkan pilih">
        </el-date-picker>
      </div>
    </el-form-item>
    <el-form-item label="waktu penggunaan">
      <div class="block">
        <el-date-picker v-model="searchForm.useStartTime" type="date" :picker-options="pickerOptions3" :editable="false" placeholder="Silahkan pilih">
        </el-date-picker> ~
        <el-date-picker v-model="searchForm.useEndTime" type="date" :picker-options="pickerOptions4" :editable="false" placeholder="Silahkan pilih">
        </el-date-picker>
      </div>
    </el-form-item><br>
  ...
  <template>
    <el-table :data="gridData" ref="multipleTable" tooltip-effect="dark" highlight-current-row v-loading="gridLoading"  class="grid">
      <el-table-column label="Nama Kupon" prop="indonisaName" width="150">
      </el-table-column>
      <el-table-column label="Jumlah" prop="money" width="150">
      </el-table-column>
      ...
      <el-table-column label="waktu pembagian" prop="sendTime" width="150" sortable>
      </el-table-column>
      <el-table-column label="waktu penggunaan" prop="usedTime" width="150" sortable>
      </el-table-column>
      <el-table-column label="masa berlaku" prop="validateTime" width="200" sortable>
      </el-table-column>
      <el-table-column label="Nomor Permohonan" prop="orderNo" width="200" sortable>
      </el-table-column>
