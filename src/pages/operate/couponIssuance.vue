<template>
  <section>
    ...
    <el-form :inline="true" class="toolbar">
      <el-form-item>
        <el-button @click="add" type="success">添加优惠券</el-button>
      </el-form-item>
    </el-form>
    <!--列表-->
    <template>
      <el-table :data="gridData" highlight-current-row v-loading="gridLoading" class="grid">
        ...
        <el-table-column label="优惠券名称(印尼文)">
          <template scope="scope">
            <el-tooltip effect="dark" placement="bottom-start">
              <div slot="content">
        ...
        <el-table-column label="操作" width="300">
          <template scope="scope">
            ...
            <el-button size="small" @click="handleSend(scope.$index,scope.row)">手动发放</el-button>
          </template>
        </el-table-column>
        <div class="higer"></div>
      </el-table>
...
<table border="0" style="width:100%; margin-left:-2px; ">
  <tr>
    <td style=" "><el-input v-model='handleAddData.userName' placeholder='姓名' required></el-input></td>
    ...
    <td><el-input v-model='handleAddData.money' :disabled="handleSendFackeValue" placeholder='金额'></el-input></td>
    <td> <el-date-picker style="width:150px"  v-model="handleAddData.validityStartTime" type="date" :picker-options="pickerOptions1" :editable="false" placeholder="选择日期">
    </el-date-picker></td> ~  <td><el-date-picker style="width:150px" v-model="handleAddData.validityEndTime" type="date" :picker-options="pickerOptions2" :editable="false" placeholder="选择日期">
    </el-date-picker></td>
  <!--   <td style="width: 13%">            
      <el-table-column><span style="color: white">_</span><el-checkbox v-model="mobileMess"></el-checkbox></el-table-column>
    </td> -->
    <td><el-button @click='handleAdd' style='margin:0 auto;' type='primary' size="small">添加</el-button></td>
  </tr>
</table>
