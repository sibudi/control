      ...
      <el-row>
        ...
        <div style="clear:both;">
          <el-col :span="5" class="grid-content">
            ...
            <div><span>当前年龄:</span><span>{{ customerInfo.age }}</span></div>
          </el-col>
          ...
          <el-col :span="12" class="grid-content">
            <div><span>身份归属地:</span><span>{{ customerInfo.idcardAddress }}</span></div>
    ...
    methods: {
      ...
      customerDataInfo(){
        ...
        this.getUserThirdData({uuid:this.uuid,dataType:3},(data) =>{
          try{
            //console.log(" 3 result = ",JSON.parse(data.data));
        ...
        this.$http.post('manage/yituImgUrl',{uuid:this.uuid}).then(response =>{
            ...
            if(1 == body.code && body.data){
              this.yituRecog.IDImgSrc = Config.imageUrl+body.data[0].userIdentityUrl;
