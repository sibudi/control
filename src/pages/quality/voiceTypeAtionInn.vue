<template>
  <section>
    ...
    <el-form :inline="true" class="toolbar">
      <el-form-item>
        <el-button @click="add" type="success">Tambahkan</el-button>
      </el-form-item>
    </el-form>
    <!--列表-->
    <template>
      <el-table :data="gridData" highlight-current-row v-loading="gridLoading" class="grid">
        <el-table-column label="Judul bahasa Cina">
        ...
        <el-table-column label="Judul bahasa indonesia">
          <template scope="scope">
            <el-tooltip effect="dark" placement="bottom-start">
              <div slot="content">
        ...
        <el-table-column prop="fineMoney" label="Denda" width="150">
        </el-table-column>
        <el-table-column label="Operasi" width="200">
          <template scope="scope">
