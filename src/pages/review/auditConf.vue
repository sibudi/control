...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //基础信息table
      baseInfoAjax() {
        this.commonTableData('manage/autoReviewList', 'baseIdInfoTableLoading', 'baseIdInfoTable', {type: 1});
      },
      //芝麻分table
      zhimaAjax() {
      ...
      //
      otherAjax() {
        this.commonTableData('manage/autoReviewList', 'otherTableLoading', 'otherTable', {type: 5});
      },
      //黑名单
      blackListAjax() {
